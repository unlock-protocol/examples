...
exports.hasMembership = exports.web3Service = void 0;
const unlock_js_1 = require("@unlock-protocol/unlock-js");
exports.web3Service = new unlock_js_1.Web3Service({
    "56": {
    ...
    "1": {
        id: 1,
        publicProvider: "https://eth-mainnet.alchemyapi.io/v2/6idtzGwDtRbzil3s6QbYHr2Q_WBfn100",
...
async function hasMembership(userAddress, paywallConfig) {
    for (const [lockAddress, { network }] of Object.entries(paywallConfig.locks)) {
        const keyId = await exports.web3Service.getTokenIdForOwner(lockAddress, userAddress, network);
        if (keyId > 0) {
            return true;
        }
    }
